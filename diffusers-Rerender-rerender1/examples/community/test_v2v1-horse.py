...
input_video_path = "/home/ubuntu/sws/recursive/Rerender_A_Video/videos/horserunning.mp4" #"/home/ubuntu/sws/recursive/Rerender_A_Video/videos/horserunning.mp4"
input_interval = 2
...
output_frames = pipe(
    ...
    "A horse was running in the desert, sand flying between its hooves,RAW photo, subject, (high detailed skin:1.2), 8k uhd, dslr, soft lighting, high quality, film grain, Fujifilm XT3",
...
export_to_video(
    output_frames, "/home/ubuntu/sws/recursive/Rerender_A_Video/videos/horserunning_diffout-canny2.mp4", 5)