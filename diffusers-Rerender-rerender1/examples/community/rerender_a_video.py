...
class RerenderAVideoPipeline(StableDiffusionControlNetImg2ImgPipeline):
    ...
    def __call__(
        ...
        checkpoint = torch.load("/home/ubuntu/sws/recursive/Rerender_A_Video/models/gmflow_sintel-0c07dcb3.pth", map_location=lambda storage, loc: storage)
        ...
        if isinstance(controlnet, ControlNetModel):
            ...
            control_images = []
            control_each_image = []
            for control_each in control_frames:
                control_each_image.append(control_each[0])

            for control_image_ in control_each_image:
        ...
        for idx in range(1, len(frames)):
            ...
            if isinstance(controlnet, ControlNetModel):
                ...
                control_each_image = []
                for control_each in control_frames:
                    control_each_image.append(control_each[idx])
