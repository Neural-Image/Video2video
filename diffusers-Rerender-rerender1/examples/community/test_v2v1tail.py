...
for frame in frames:
    ...
    tail_image = Image.fromarray(frame)
    control_frames.append(tail_image)

# You can use any ControlNet here
controlnet = ControlNetModel.from_pretrained(
    "/home/ubuntu/sws/model/controlnet11/control_v11f1e_sd15_tile").to('cuda')
...
export_to_video(
    output_frames, "/home/ubuntu/sws/recursive/Rerender_A_Video/videos/demo_diffout11tail.mp4", 5)