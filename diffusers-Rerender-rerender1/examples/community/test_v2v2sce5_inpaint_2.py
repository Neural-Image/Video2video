...
output_path="/home/ubuntu/liudong/diffusers-Rerender-rerender/video/sce52inpaint-tail_diffout_basemodel_28.mp4"

input_frame_path="/home/ubuntu/sws/data/horse_mask/blend_out7" #"/home/ubuntu/sws/data/testsce5/merged" #"/home/ubuntu/liudong/diffusers-Rerender-rerender/video/moved_imgs11" # # #"/home/ubuntu/sws/data/testsce5/merged"


horse_mask_path="/home/ubuntu/sws/data/horse_mask/horse1mask_ground_dilate1" #
...
control_frames = [control_lineart_frames,control_tile_frames,control_inpaint_frames]
...
output_frames = pipe_refine(
    # "white ancient Greek sculpture, Venus de Milo, light pink and blue background",There are mountains in the desert and white clouds in the sky,
    "sand flying,two horse were running in the desert, sand flying between their hooves",#,RAW photo, subject, (high detailed skin:1.2), 8k uhd, dslr, soft lighting, high quality, film grain, Fujifilm XT3",
    frames=frames,
    control_frames=control_frames,
    num_inference_steps=20,
    strength=0.95,#0.95,
    controlnet_conditioning_scale=[0.8,0.35,0.5],  # lineart ,tile, inpatint
    generator=generator,
    warp_start=0.0,
    warp_end=0.1,
    mask_start=0.5,
